...
async def edit_user_view(request: Request):
    ...
    return template.TemplateResponse('edit-user-password.html', {'request': request, 'user': user})
...
async def user_password_change(request: Request, username: str = Form(...),
    ...
    return template.TemplateResponse("edit-user-password.html", {'request': request, 'user': user, 'msg': msg})